...
export default {
  ...
  data() {
    return {
      ...
      userLang: String,
      startChatText: 'Chat',
      apiUrl: 'https://171e406e010a.ngrok.io/bot/',
  ...
  methods: {
    chargeAgent() {
      axios.get('https://171e406e010a.ngrok.io/chatbot/' + this.token).then(response => {
    ...
    saveLeadData:function(userName,userEmail)
    {
     try{
       ...
       axios.put('https://171e406e010a.ngrok.io/user_lead/' + this.token+'/'+loggedUserId,leadDataObj).then(response => {
