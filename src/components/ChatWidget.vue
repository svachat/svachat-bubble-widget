...
export default {
  ...
  data() {
    return {
      ...
      userLang: String,
      startChatText: 'Chat',
      apiUrl: process.env.API_URL_PREFIX_DEV +'bot/'
    };
  },
  props: {
    // welcome: String,
  ...
  mounted() {    
   ...
   var encryptedData= "";
   var decryptedData= this.CryptoJS.AES.decrypt(encryptedData, process.env.ENC_DECRYPT_KEY).toString(this.CryptoJS.enc.Utf8); 
   console.log("Decrypted Text : "+ decryptedData);
  },
  methods: {
    chargeAgent() {
      axios.get(process.env.API_URL_PREFIX_DEV+'chatbot/' + this.token).then(response => {
